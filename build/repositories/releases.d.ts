...
declare const _default: {
     ...
     */
    getRepositoryReleases: () => Promise<Endpoints["GET /repos/{owner}/{repo}/releases"]["response"]>;
    /**
     * Gets data about a single release
     * @param  {string} releaseId 	The ID of the release
     * @return {JSON}           	The release data
     */
    getRepositoryRelease: (releaseId: string) => Promise<Endpoints["GET /repos/{owner}/{repo}/releases/{release_id}"]["response"]>;
    /**
     ...
     * @return {JSON}           	The release data
     */
    getLatestRepositoryRelease: () => Promise<Endpoints["GET /repos/{owner}/{repo}/releases/latest"]["response"]>;
    /**
     ...
     * @return {JSON}           	The release data
     */
    getRepositoryReleaseByTagName: (tag: string) => Promise<Endpoints["GET /repos/{owner}/{repo}/releases/tags/{tag}"]["response"]>;
    /**
     ...
     * @return {JSON}           	The release data
     */
    createRelease: (body: any) => Promise<Endpoints["POST /repos/{owner}/{repo}/releases"]["response"]>;
    /**
     ...
     * @return {JSON}           	The release data
     */
    updateRelease: (releaseId: string, body: any) => Promise<Endpoints["PATCH /repos/{owner}/{repo}/releases/{release_id}"]["response"]>;
    /**
     * Users with push access to the repository can delete a release.
     * @param  {string} releaseId 	The ID of the release
     * @return {string}           	Undefined on success, otherwise an error message
     */
    deleteRelease: (releaseId: string) => Promise<Endpoints["DELETE /repos/{owner}/{repo}/releases/{release_id}"]["response"]>;
    /**
     * Gets a list of existing assets for a release.
     * @param  {string} releaseId 	The ID of the release
     * @return {JSON}           	A list of asset data
     */
    getReleaseAssets: (releaseId: string) => Promise<Endpoints["GET /repos/{owner}/{repo}/releases/assets/{asset_id}"]["response"]>;
    /**
     ...
     */
    uploadReleaseAsset: (uploadUrl: string, assetName: string, assetLabel: string, localFilePath: string, contentType: string) => Promise<Endpoints["POST {origin}/repos/{owner}/{repo}/releases/{release_id}/assets{?name,label}"]["response"]>;
    /**
     ...
     * @return {JSON}         		The asset data
     */
    getReleaseAssetData: (assetId: string) => Promise<Endpoints["GET /repos/{owner}/{repo}/releases/assets/{asset_id}"]["response"]>;
    /**
     ...
     * @return {JSON}				The asset data
     */
    updateReleaseAsset: (assetId: string, body: any) => Promise<Endpoints["PATCH /repos/{owner}/{repo}/releases/assets/{asset_id}"]["response"]>;
    /**
     * Deletes an asset from a release
     * @param  {string} assetId 	The ID of the asset
     * @return {string}           	Undefined on success, otherwise an error message
     */
    deleteReleaseAsset: (assetId: string) => Promise<Endpoints["DELETE /repos/{owner}/{repo}/releases/assets/{asset_id}"]["response"]>;
};
