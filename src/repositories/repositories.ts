...
export default {
   ...
   */
  getMyRepos: function (params?: RepoParams) {
    return req.standardRequest(
      `${config.host}/user/repos?${req.assembleQueryParams(params, [
        "visibility",
        "affiliation",
        "type",
        "sort",
   ...
   * @return {JSON} repo data
   */
  getUserRepos: function (username: string, params?: Params) {
    return req.standardRequest(
      `${config.host}/users/${username}/repos?${req.assembleQueryParams(
        params,
   ...
   * @return {JSON} repo data
   */
  getOrgRepos: function (org: string, params?: Params) {
    return req.standardRequest(
      `${config.host}/orgs/${org}/repos?${req.assembleQueryParams(params, [
        "type",
        "page",
      ])}`
   ...
   * @return {JSON} repo data
   */
  getPublicRepositories: function (params?: Params) {
    return req.standardRequest(
   ...
   * @return {JSON} repo data
   */
  createUserRepository: function (body: RepoBody) {
    return req.standardRequest(
   ...
   * @return {JSON} repo data
   */
  createOrgRepository: function (org: string, body: RepoBody) {
    return req.standardRequest(
   ...
   * @return {JSON} repo data
   */
  updateRepository: function (owner: string, repo: string, body: RepoBody) {
    return req.standardRequest(
      `${config.host}/repos/${owner}/${repo}`,
      "patch",
      body
   ...
   * @return {JSON} repo data
   */
  getRepositoryTopics: function (owner: string, repo: string, params?: Params) {
    return req.standardRequest(
      `${config.host}/repos/${owner}/${repo}/topics?${req.assembleQueryParams(
        params,
        ["since"]
      )}`
    ) as Promise<
   ...
   * @return {JSON} repo data
   */
  updateRepositoryTopics: function (owner: string, repo: string, body: Body) {
    return req.standardRequest(
   ...
   * @return {JSON} repo data
   */
  getRepositoryContributors: function (
    owner: string,
    repo: string,
    params?: Params
  ) {
    return req.standardRequest(
      `${
        config.host
      }/repos/${owner}/${repo}/contributors?${req.assembleQueryParams(params, [
        "anon",
        "page",
      ])}`
    ) as Promise<
   ...
   * @return {JSON} repo data
   */
  getRepositoryTeams: function (owner: string, repo: string, params?: Params) {
    return req.standardRequest(
      `${config.host}/repos/${owner}/${repo}/teams?${req.assembleQueryParams(
        params,
        ["page"]
      )}`
    ) as Promise<
   ...
   * @return {JSON} repo data
   */
  getRepositoryTags: function (owner: string, repo: string, params?: Params) {
    return req.standardRequest(
      `${config.host}/repos/${owner}/${repo}/tags?${req.assembleQueryParams(
        params,
        ["page"]
      )}`
    ) as Promise<
   ...
   * @return {nothing}
   */
  deleteRepository: function (owner: string, repo: string) {
    return req.standardRequest(
      `${config.host}/repos/${owner}/${repo}`,
      "delete"
